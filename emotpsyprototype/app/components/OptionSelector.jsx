...
export default function OptionSelector({ onSelect }) {
  return (
    <div className="space-y-6">
      <h1 className="text-3xl text-center font-bold text-blue-800">Willkommen zu unseren AGB</h1>
      <p className="text-m text-blue-400">
      ...
      <p className="text-blue-700 text-xl font-bold">Vorschau: </p>
      {/* Vorschau-Fenster */}
